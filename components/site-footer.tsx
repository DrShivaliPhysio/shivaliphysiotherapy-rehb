...
export function SiteFooter() {
  return (
    <footer id="contact" className="border-t border-border">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-2 md:px-6">
          ...
          <div>
            ...
            <p className="mt-3 max-w-md text-base leading-relaxed text-muted-foreground">
              Book a consultation, ask a quick question, or join the waitlist for the upcoming Haryana clinic.
            </p>
          </div>
          ...
          <div className="grid gap-3">
            ...
            <a
              ...
              className="
                group flex items-center justify-between rounded-2xl border border-border bg-background px-5 py-4
            ...
            >
              <div className="flex items-center gap-3">
                <span className="
                  ...
                  group-hover:scale-110 group-hover:rotate-6 group-hover:bg-primary/10
                ">
                  <svg viewBox="0 0 24 24" className="h-4 w-4 fill-primary transition-transform duration-300 group-hover:scale-110" >
      ...
      {/* MAIN FOOTER */}
      <div className="mx-auto bg-background grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-[1.4fr_1fr_1fr] md:px-6">
          ...
          <div className="mt-5 flex gap-3">
            {socialMediaLinks.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="
                  group relative flex h-10 w-10 items-center justify-center rounded-full border border-border
                  text-muted-foreground transition-all duration-300

                  hover:-translate-y-1 hover:scale-110
                  hover:text-white hover:shadow-lg hover:shadow-primary/20
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-4 py-6 text-xs text-muted-foreground md:flex-row md:px-6">
          <p>
            © {new Date().getFullYear()} {Constants.doctorName} Physiotherapy. All rights reserved.
          </p>
        </div>
      </div>
